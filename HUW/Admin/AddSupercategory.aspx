<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddSupercategory.aspx.cs" Inherits="Admin_AddSupercategory" MasterPageFile="~/Admin/AdminMaster.master" %>
            ...
            <ul class="form_fields_container">
                <li>
                    <div class="two_colfields">
                        <label id="lblCouponCode">Super Category Name</label>
                        <div class="form_input">
                            <asp:TextBox ID="txtsupercategory" runat="server" />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtsupercategory"  runat="server" ErrorMessage="Enter Super Category"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                </li>      
                <li>
