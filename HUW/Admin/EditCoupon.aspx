<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditCoupon.aspx.cs" Inherits="Admin_EditCoupon" MasterPageFile="~/Admin/AdminMaster.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="widget">
        ...
        <asp:Label ID="lblCoupon_Id" runat="server" Visible="false"></asp:Label>
        <div class="widget_body">
            <ul class="form_fields_container">
                ...
                <li>
                    ...
                    <div class="two_colfields" id="divAmount" runat="server">
                    ...
                    <div class="two_colfields" id="divPercentage" runat="server">
