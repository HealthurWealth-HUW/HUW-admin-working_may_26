...
public partial class Admin_DownloadSalesReports : System.Web.UI.Page
{
            ...
            using (SqlCommand cmd = new SqlCommand("Sp_DispatchOrdersNew"))
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    ...
                    using (DataSet ds = new DataSet())
                    {
                        ...
                        ds.Tables[0].TableName = "Sales Report";
                        ...
                        using (XLWorkbook wb = new XLWorkbook())
                        {
                            ...
                            Response.AddHeader("content-disposition", "attachment;filename=HealthurwealthSalersReport.xlsx");
