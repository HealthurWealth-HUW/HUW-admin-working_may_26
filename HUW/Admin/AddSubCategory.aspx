<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddSubCategory.aspx.cs" Inherits="Admin_AddSubCategory"  MasterPageFile="~/Admin/AdminMaster.master"%>
        ...
        <div class="widget_body">
            <ul class="form_fields_container">
                ...
                <li>
                            ...
                            <div>
                                <span class="oneThree">
                                    <asp:DropDownList ID="ddlCategory" Style="height: 25px; width: 123px;" runat="server"
                                        AutoPostBack="true">
                                    </asp:DropDownList>
                ...
                <li>
                    <div class="two_colfields">
                        <label id="lblCouponCode">SubCategoryName</label>
                        <div class="form_input">
                            <asp:TextBox ID="txtSubCategoryname" runat="server" />
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="ddlCategory" runat="server" ErrorMessage="Enter Sub Category"></asp:RequiredFieldValidator>
