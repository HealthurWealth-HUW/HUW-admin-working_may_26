<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster1.master" AutoEventWireup="true" CodeFile="prescriptionupdatenew.aspx.cs" Inherits="Admin_prescriptionupdatenew" %>
        ...
        function updatestatus(selected) {
            ...
            if (r == true) {
                ...
                $.ajax({
                    ...
                    url: '../api/Master/Updatestatus?status=' + selected.value + '&orderid=' + $('#ContentPlaceHolder1_DDlstatus').html(),
                    type: 'post',
                    dataType: 'json',
                    success: function (data) {
                        window.location.href = "../Admin/prescriptionupdatenew.aspx?transid=" + $('#ContentPlaceHolder1_DDlstatus').html();
                    },
                    error:
                    {
                        //Show error message
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="widget">
        <div class='widget_title'>
            <h5>
                <label id='Label1'><b>&nbsp;&nbsp;&nbsp;&nbsp;Update Prescription Details</b></label>
            </h5>
        </div>
    </div>
        ...
        <div>
            ...
            <div>
              ...
              <div class="col-lg-6 right-half">
                ...
                <div class="col-md-6 left-half form-group">
                    <div class="col-12">
