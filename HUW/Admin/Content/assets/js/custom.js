...
$(function () {
	if (localStorage.getItem("skincolor") != null) {
		$("body").attr("data-default-color", localStorage.getItem("skincolor"));
	}
	$(".change-colors li").on("click", function () {
		localStorage.setItem("skincolor", $(this).data("color"));
		$("body").attr("data-default-color", $(this).data("color"));

	});

	$(".change-colors li").on("click", function () {
		$(".card-title").attr("data-default-color", $(this).data("color"));
	});
	$(".change-colors li").on("click", function () {
		localStorage.setItem("skin-color-bg", $(this).data("color"));
		$("body").attr("data-default-color", $(this).data("color"));
...
// function changeColors(secondaryColor) {

// 	document.documentElement.style.setProperty('--thickgreen', secondaryColor);
// }
