...
(function(a) {
	...
	a.extend(!0, d.defaults, {
		dom: "<'row'<'col-sm-12 col-md-6 mt-2 mt-sm-0'l><'col-sm-12 col-md-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
		renderer: "bootstrap"
	});
	a.extend(d.ext.classes, {
		sWrapper: "dataTables_wrapper dt-bootstrap5",
		sFilterInput: "form-control form-control-sm radius-20",
