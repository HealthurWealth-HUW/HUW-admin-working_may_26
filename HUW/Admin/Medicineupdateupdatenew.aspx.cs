...
public partial class Admin_Medicineupdateupdatenew : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            using (db_Zon_HuwEntities context = new db_Zon_HuwEntities())
            {
                ...
                Tbl_Prescriptionorders data = context.Tbl_Prescriptionorders.Where(x => x.OrderId == transid && x.OrderplacedUrl == "HUW").FirstOrDefault();
                ...
                txtpincode.Text = data.Pincode; txtAmount.Text = data.Amount.ToString();
                ...
                txtdiscountamount.Text = data.DiscountAmount.ToString();
                txtpaymentmode.Text = data.PaymentMode;
                txtdeliveryby.Text = data.DeliveredBy;
                ...
                Date.Text = data.CreatedOn.Value.ToString("dd/MMM/yyyy");
            }
        }
    }
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        using (db_Zon_HuwEntities context = new db_Zon_HuwEntities())
        {
            ...
            {
                orders.DiscountAmount = Convert.ToDecimal(txtdiscountamount.Text);
            }
            orders.PaymentMode = txtpaymentmode.Text;
            orders.DeliveredBy = txtdeliveryby.Text;
