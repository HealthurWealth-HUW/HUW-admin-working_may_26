<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReturnOrders.aspx.cs" MasterPageFile="~/Admin/AdminMaster.master" Inherits="Admin_ReturnOrders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Updatedeliverystatus(txnid) {
            if (confirm("Are you sure that the product is received. This action can't be edited again!!")) {
            if ($('#chkreturn_' + txnid).is(":checked")) {
                //alert("checked");
                $.ajax({
                    contentType: "application/json; charset=utf-8",
                    url: '../api/Master/UpdateReturnStatus?ID=' + txnid,
                    type: 'Get',
                    dataType: 'json',
                    success: function (data) {
                        if (data.Status == "Success") {
                            $('#divMsg').html("Product received Updated").show();
                            GetRTOOrders();
    ...
    <div id="" class="pr">
        <div id="cp_placeholder">
            ...
            <div id="activity_stats">
                <h1>
                    <label id="ctl00_ctl00_Main_Main_lblPageTitle">Return Orders</label>
                </h1>
            </div>
            <!--Quick Actions-->
            ...
            <div class="one_wrap fl_left">
                ...
                <div id="ctl00_ctl00_Main_Main_UpdatePanel1">
                    ...
                    <input style='display: inline-block;' type='button' onclick='ExporttoExcel()' class='button_small greyishBtn fl_right btn btn-sm btn-pink' value='Export to Excel' />

                    <div id="divReturnPaymentOrdersGrd"></div>
                </div>
