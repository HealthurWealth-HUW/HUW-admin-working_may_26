<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="DispatchedOrders.aspx.cs" Inherits="Admin_DispatchedOrders" %>
...
<script src="../JavaScript/vpb_script.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function ExporttoExcel() {
            $("#divDispatchedtOrdersGrd").table2excel({
                name: "Worksheet Name",
    ...
    <div id="content_wrap">
        <div id="cp_placeholder">
            ...
            <div id="activity_stats">
                <h1>
                    <label id="ctl00_ctl00_Main_Main_lblPageTitle">Dispatched Orders</label>
                </h1>
            </div>
            <!--Quick Actions-->
            ...
            <div class="one_wrap fl_left">
                ...
                <div id="ctl00_ctl00_Main_Main_UpdatePanel1">
                    ...
                    <div id="divDispatchedtOrdersGrd"></div>
                    <div runat="server" id="liemplist">
                    <input type="button" onclick="pushdispatchedtodelivered()" value="Move Delhivery orders to delivered"/>
                    <input type="button" onclick="pushshipdispatchedtodelivered()" value="Move Shiprocket orders to delivered"/>
                          <input type="button" onclick="pushbluedispatchedtodelivered()" value="Move Bluedary orders to delivered"/>
                        </div>
                </div>
            ...
            <div class="widget">
                <div class="widget_body">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td style="width: 40%; text-align: right; padding-right: 10px;">
                                <label id="Label1">Order ID</label></td>
                    ...
                    <div class="action_bar text_right">
                        ...
                        <input value="Ship" onclick='UpdateDispatchedOrders()' id="Submit1" class="button_small greyishBtn" type="button" />
    ...
    <script>
        ...
        function pushbluedispatchedtodelivered() {
            $.ajax({
                url: '../api/Master/UpdatetodeliveredusingBluedartapi',
                type: 'post',
                dataType: 'json',
                success: function (data) {
                }
        ...
        function pushshipdispatchedtodelivered() {
            $.ajax({
                url: '../api/Master/UpdatetodeliveredusingShiprocketapi',
                type: 'post',
                dataType: 'json',
                success: function (data) {
                }
        ...
        function pushdispatchedtodelivered() {
            $.ajax({
                url: '../api/Master/Updatetodeliveredusingapi',
                type: 'post',
                dataType: 'json',
                success: function (data) {
                }
