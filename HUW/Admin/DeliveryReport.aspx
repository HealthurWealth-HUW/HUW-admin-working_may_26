<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeliveryReport.aspx.cs" Inherits="Admin_DeliveryReport" MasterPageFile="~/Admin/AdminMaster.master" %>
            ...
            <div class="search_contentpad">
                ...
                <div class="margin_10" id="margin_10">
                    <ul class="form_fields_container">
                        ...
                        <asp:Button ID="btninvidexcel" runat="server" Text="Download Invice Excel" CssClass="btn btn-primary" OnClick="btninvidexcel_Click" />
                        </li>
                    </ul>
                </div>
            </div>
