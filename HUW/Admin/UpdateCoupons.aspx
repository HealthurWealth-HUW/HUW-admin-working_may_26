<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="UpdateCoupons.aspx.cs" Inherits="Admin_UpdateCoupons" %>
...
<%--        <script type="text/javascript">
    ...
    <label id="hiddenlbl" runat="server" visible="false" style="background: coral;
    width: 95%;
    text-align: center;
    display: block;
    padding: 10px;
                      ...
                      <div class="two_colfields">
                       ...
                       <div class="form_input">
                            <div id="lblDescription">
                                <textarea id="txtDescription" cols="16" rows="4" runat="server"></textarea>
                            </div>
                        </div>
                    </div> 
                    <div class="two_colfields">
                       ...
                       <div class="form_input">
                            <div id="lbltc">
                                <textarea id="txttc" cols="20" rows="2" runat="server"></textarea>
                            </div>
                        </div>
                    </div>
                       <div class="two_colfields">
