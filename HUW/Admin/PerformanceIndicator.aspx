<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="PerformanceIndicator.aspx.cs" Inherits="Admin_PerformanceIndicator" %>
    ...
    <div id="content_wrap">
        <div id="cp_placeholder">
            ...
            <div id="activity_stats">
                <h1>
                    <label id="ctl00_ctl00_Main_Main_lblPageTitle">Performance Indicator</label>
                </h1>
            </div>
            <!--Quick Actions-->
            ...
            <div class="one_wrap fl_left">
                ...
                <div id="ctl00_ctl00_Main_Main_UpdatePanel1">
                    <div id="divPerformanceIndicator"></div>
                </div>
