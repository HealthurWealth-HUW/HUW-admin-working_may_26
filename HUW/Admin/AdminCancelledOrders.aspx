<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AdminCancelledOrders.aspx.cs" Inherits="Admin_AdminCancelledOrders" %>
    ...
    <div id="content_wrap">
        <div id="cp_placeholder">
            ...
            <div id="activity_stats">
                <h1>
                    <label id="ctl00_ctl00_Main_Main_lblPageTitle">Admin Cancelled Orders</label>
                </h1>
            </div>
            <!--Quick Actions-->
