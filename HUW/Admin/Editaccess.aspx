<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Editaccess.aspx.cs" Inherits="Admin_Editaccess" %>
                                ...
                                <ul class="form_fields_container">
                                    <li>
                                      ...
                                      <div class="globalaction_bar text_right">
                                         ...
                                         <asp:Button ID="btnSavedetails" Style="margin-top: 2px;" class="button_small greyishBtn" runat="server" Text="Update" OnClick="btnSavedetails_Click" />
                                        </div>
