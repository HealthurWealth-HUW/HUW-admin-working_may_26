<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/AdminMaster.master" CodeFile="DownloadDispatchReports.aspx.cs" Inherits="Admin_DownloadDispatchReports" %>
                ...
                <div class='one_wrap ' id='divSearchResult' style=''>
                    <div id='divSearchgrids' class='widget' style=''>
                        <div class='widget_title'>
                            ...
                            <h5>
                                <label id='ctl00_ctl00_Main_Main_lblProductList'><b>&nbsp;&nbsp;&nbsp;&nbsp;Download Dispatch Report </b></label>
                            </h5>
                        </div>
                                    ...
                                    <ul class="form_fields_container">
                                        <li>
                                            ...
                                            <div class="form_input fl_left">
                                                <input type="text" id="txtFromDate" placeholder="2021-12-01 " runat="server" class="hasDatepicker" name="txtFromDate" />
                                        ...
                                        <li>
                                            ...
                                            <div class="form_input fl_left">
                                                <input type="text" id="txtToDate" placeholder="2021-12-01 "  runat="server" class="hasDatepicker"  name="txtToDate" />
