...
public partial class Admin_SalesReport : System.Web.UI.Page
{
    ...
    {
        //LoadDashboard(Convert.ToDateTime("" + DateTime.Now.Year + "-" + DateTime.Now.Month + "-01"), DateTime.Now);

    }
    
    public void DownloadExcel(DateTime fromdate, DateTime todate, string currentstatus)
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("Sp_DispatchOrdersNew"))
            {
                ...
                cmd.Parameters.Add("@OrderCurrentStatus", SqlDbType.VarChar).Value = currentstatus;
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    ...
                    using (DataSet ds = new DataSet())
                    {
                        ...
                        ds.Tables[0].TableName = "Gst Sales report";
                        ds.Tables[1].TableName = "Sales report";
                        ...
                        using (XLWorkbook wb = new XLWorkbook())
                        {
                            ...
                            Response.AddHeader("content-disposition", "attachment;filename=Healthurwealthsalesreport.xlsx");
    ...
    {
        DownloadExcel(Convert.ToDateTime(txtFromDate.Value), Convert.ToDateTime(txtToDate.Value), drpOrderStatuss.Value.ToString());
        //LoadDashboard(Convert.ToDateTime(txtFromDate.Value), Convert.ToDateTime(txtToDate.Value));
    }
}