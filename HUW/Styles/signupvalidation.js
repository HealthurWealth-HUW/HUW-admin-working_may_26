$(document).ready(function(){
    ...
    $(".buttonbg").click(function(){
        ...
        validateEmail();
        checkdate();
        if(validateverification() & checkdate() & validatecoun() & validateSec() & validatesecQues() &  validatePass2() & validatePass1() & validateName() & validateEmail_confirm() &  validateEmail() )
        {
            return true;
        }
        else
